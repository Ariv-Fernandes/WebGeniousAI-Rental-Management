...
function ProductDetail(){
  ...
  if(loading){
    ...
    <div>
     ...
     <section className="overflow-hidden h-full py-11 font-poppins dark:bg-gray-800" style={{ backgroundSize: "cover", }}> 
     <div className="max-w-6xl px-4 py-4 mx-auto lg:py-8 md:px-6 w-fitbg-white border border-gray-200 bg-gradient-to-r from-blue-100 to-blue-400 rounded-lg shadow dark:bg-gray-800" style={{ marginTop: "40px", }}>
          <div class="flex flex-wrap -mx-4">
            <div class="w-full px-4 md:w-1/2 ">
              <div class="sticky top-0 z-50 overflow-hidden ">
                 {details.img.img1 &&  <div className="relative mb-6 rounded-md lg:mb-10 lg:h-2/4 overflow-hidden group h-[287]">
                  <img
