...
function Contact(){
    ...
    <section class="bg-white dark:bg-gray-900" style={{backgroundColor:'aliceblue'}}>
        <h1 class="font-extrabold text-4xl text-center p-5" style={{margin:'5px'}}>Contact Us</h1>
    <div class="grid max-w-screen-xl px-4 mx-auto lg:gap-8 xl:gap-0  lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-7" style={{width:'500px', marginLeft:'60px'}}>
...
<form class="max-w-sm mx-auto" style={{marginBottom:'20px'}}>
  ...
  <div style={{marginBottom:'1.75rem'}}>
      <label for="base-input" class="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Email</label>
      <input type="text" id="base-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"/>
  </div>
  <div style={{marginBottom:'1.75rem'}}>
      <label for="large-input" class="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Message</label>
