  ...
  const handleClick = () => {
    ...
    <div class="grid max-w-screen-xl px-4 py-8 mx-10 lg:gap-8 xl:gap-0  lg:grid-cols-12" style={{margin:'25px'}}>
        <div class="mr-auto place-self-center lg:col-span-7">
            ...
            <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste tempore amet molestiae id consequuntur ducimus voluptatum, a cum sequi est iure ipsa modi ex perferendis temporibus fuga impedit odio.
            
             In, at porro. Deleniti alias suscipit accusamus repellat. Aliquam, facilis dolor!</p>

             <button onClick={handleClick} type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
             Learn More
            </button>
       ...
       {isVisible && <section class=" bg-teal-300 dark:bg-gray-900">
