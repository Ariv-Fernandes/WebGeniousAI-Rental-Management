function Features() {
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-8 lg:px-6">
      ...
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0 ">
          <div class="bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700 shadow-2xl hover:bg-gray-100 dark:hover:bg-gray-600 hover:border-sky-800 dark:hover:border-blue-900 transition duration-300 ease-in-out" style={{ padding: '20px' }}>
          ...
          <div class="bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700 shadow-2xl  hover:bg-gray-100 dark:hover:bg-gray-600  transition duration-300 ease-in-out" style={{ padding: '20px' }}>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
