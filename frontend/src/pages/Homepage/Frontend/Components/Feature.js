function Rent(){
    ...
    <div class="grid max-w-screen-xl px-4 mx-auto lg:gap-8 xl:gap-0  lg:grid-cols-12">
        <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
            <img src="https://img.freepik.com/free-vector/concept-house-searching-landing-page_52683-25530.jpg?w=1480&t=st=1704450366~exp=1704450966~hmac=e1139ca17d9de2c5a2ed1ce859791f30ea22699860908290a14f0ddea6f29141" alt="mockup" style={{width:'500px', height:'400px'}}/>
        </div>                
